...
const faqData = [
  ...
  },
  {
    ...
    answer: "We have an exciting prize pool of 1,50,000 INR along with networking opportunities with best minds across the country"
  }
];
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <ChevronDown 
                    size={24} 
                    className={`text-red-600 transition-all duration-300 flex-shrink-0 group-hover:text-red-500 ${isOpen ? 'rotate-180' : ''}`}
                  />
                </button>
