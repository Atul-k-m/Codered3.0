...
export const Plasma = ({
  ...
  useEffect(() => {
    ...
    // make canvas fill the parent and stay above parent's background
    ...
    canvas.style.pointerEvents = 'none'; // don't block UI interactions
    ...
    const setSize = () => {
      // Parent rect — important: parent must have a non-zero height
      const rect = containerRef.current.getBoundingClientRect();
      ...
      // initialize mouse to center so shader has sane defaults
