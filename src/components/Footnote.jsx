    ...
    >
      ...
      <span>Nishitha Bodipati</span>
            ...
            <div className="flex gap-6 mt-10">
              ...
              <a href="#" aria-label="Email" className="text-white hover:text-red-600 transition-colors">
                <Mail size={32} />
              </a>
            </div>
          </div>
          ...
          <div className="md:order-3 md:text-right">
            ...
            <ul className="space-y-5 mt-8">
              <li>
                <a href="#" className="text-white hover:text-red-600 transition-colors text-lg">
                  Campus Map
                </a>
              </li>
              <li>
